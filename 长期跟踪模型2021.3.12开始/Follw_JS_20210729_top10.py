...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into F_js20210729_top10 ({0},top10_ave) values ({1},%s)'.format(f_lcode, f_ls[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    jl_db = [3038,3107,9086,7309,4523,3349,5803,2146,2127,3148]
    jl_web = jl_db
...
#  create table F_js20210729_top10(id int not null primary key auto_increment,J3038 FLOAT,J3107 FLOAT,J9086 FLOAT,J7309 FLOAT,J4523 FLOAT,J3349 FLOAT,J5803 FLOAT,J2146 FLOAT,J2127 FLOAT,J3148 FLOAT, top10_ave FLOAT, LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ) engine=InnoDB  charset=utf8;
