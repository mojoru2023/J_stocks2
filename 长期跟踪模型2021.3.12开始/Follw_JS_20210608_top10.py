...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into F_js20210608_top10 ({0},top10_ave) values ({1},%s)'.format(f_lcode, f_ls[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    jl_db = [7202,7013,7606,9024,7272,7762,4681,6920,3099,3288]
    jl_web = jl_db
...
#create table F_js20210608_top10(id int not null primary key auto_increment, J7202 FLOAT,J7013 FLOAT,J7606 FLOAT,J9024 FLOAT,J7272 FLOAT,J7762 FLOAT,J4681 FLOAT,J6920 FLOAT,J3099 FLOAT,J3288 FLOAT,top10_ave FLOAT, LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ) engine=InnoDB  charset=utf8;
