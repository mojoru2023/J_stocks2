...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into F_js20210709_top10 ({0},top10_ave) values ({1},%s)'.format(f_lcode, f_ls[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    jl_db = [4523,3038,9086,2127,2146,7309,5803,6702,9064,3288]
    jl_web = jl_db
...
#  create table F_js20210709_top10(id int not null primary key auto_increment,J4523 FLOAT,J3038 FLOAT,J9086 FLOAT,J2127 FLOAT,J2146 FLOAT,J7309 FLOAT,J5803 FLOAT,J6702 FLOAT,J9064 FLOAT,J3288 FLOAT,top10_ave FLOAT, LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ) engine=InnoDB  charset=utf8;


#  drop  table F_js20210709_top10;