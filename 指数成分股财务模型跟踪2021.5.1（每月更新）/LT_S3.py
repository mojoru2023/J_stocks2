...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into LT_S3 ({0}) values ({1})'.format(f_lcode, f_ls[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    jl_db = [6035,6877,1925,9042,3635,2815,7419,3038,4506,8303]
    jl_web = jl_db
...
#create table LT_S3(id int not null primary key auto_increment,J6035 FLOAT , J6877 FLOAT , J1925 FLOAT , J9042 FLOAT , J3635 FLOAT , J2815 FLOAT , J7419 FLOAT , J3038 FLOAT , J4506 FLOAT , J8303 FLOAT , LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ) engine=InnoDB  charset=utf8;
