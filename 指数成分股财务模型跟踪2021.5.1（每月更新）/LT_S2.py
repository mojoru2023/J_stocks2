...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into LT_S2 ({0}) values ({1})'.format(f_lcode, f_ls[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    jl_db = [2146,8424,7974,7752,6005,6988,1893,9041,9766,2222,3064,3107,4523,8304]
    jl_web = jl_db
...
#create table LT_S2(id int not null primary key auto_increment,J2146 FLOAT , J8424 FLOAT , J7974 FLOAT , J7752 FLOAT , J6005 FLOAT , J6988 FLOAT , J1893 FLOAT , J9041 FLOAT , J9766 FLOAT , J2222 FLOAT , J3064 FLOAT , J3107 FLOAT , J4523 FLOAT , J8304 FLOAT , LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ) engine=InnoDB  charset=utf8;
