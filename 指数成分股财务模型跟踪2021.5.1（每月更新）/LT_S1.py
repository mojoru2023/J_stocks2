...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into LT_S1 ({0}) values ({1})'.format(f_lcode, f_ls[:-1]), content)
        connection.commit()
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
if __name__ == '__main__':
    jl_db = [6532,7164,7832,3003,9532,3861,6920,9104,5857,7011,4921,1721,5929,9024,4686,2811,7309,8111,7564,7459,4568,8410,8473]
    jl_web = jl_db
...
#create table LT_S1(id int not null primary key auto_increment, J6532 FLOAT , J7164 FLOAT , J7832 FLOAT , J3003 FLOAT , J9532 FLOAT , J3861 FLOAT , J6920 FLOAT , J9104 FLOAT , J5857 FLOAT , J7011 FLOAT , J4921 FLOAT , J1721 FLOAT , J5929 FLOAT , J9024 FLOAT , J4686 FLOAT , J2811 FLOAT , J7309 FLOAT , J8111 FLOAT , J7564 FLOAT , J7459 FLOAT , J4568 FLOAT , J8410 FLOAT , J8473 FLOAT ,  LastTime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP ) engine=InnoDB  charset=utf8;
